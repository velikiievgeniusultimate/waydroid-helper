...
class ContextMenuManager:
    ...
    def _save_profile_avatar(self, profile_name: str, source_path: str) -> bool:
        try:
            ...
            offset_x = (max_size - target_w) // 2
            offset_y = (max_size - target_h) // 2
            scaled.copy_area(0, 0, target_w, target_h, canvas, offset_x, offset_y)
    ...
    def _create_profile_tile(
        ...
        if avatar_path.exists():
            image = Gtk.Image.new_from_file(str(avatar_path))
            image.set_pixel_size(52)
            icon_button.set_child(image)
        else:
