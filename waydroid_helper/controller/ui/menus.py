...
class ContextMenuManager:
    ...
    def _create_profile_tile(
        ...
        if has_avatar:
            icon_button.add_css_class("profile-avatar-button")
            if profile_name == self._current_profile:
                icon_button.add_css_class("profile-avatar-button-active")
            ...
            def draw_avatar(_area: Gtk.DrawingArea, cr, width: int, height: int, pixbuf: GdkPixbuf.Pixbuf) -> None:
                ...
                cr.arc(width / 2.0, height / 2.0, min(width, height) / 2.0, 0, 6.283185307179586)
                cr.clip()
