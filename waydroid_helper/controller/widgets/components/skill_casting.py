...
class SkillCasting(BaseWidget):
    ...
    PERSPECTIVE_ANGLE_Y_SCALE_CONFIG_KEY = "skill_perspective_angle_y_scale"
    ...
    def setup_config(self) -> None:
        ...
        perspective_angle_y_scale_config = create_slider_config(
            key=self.PERSPECTIVE_ANGLE_Y_SCALE_CONFIG_KEY,
            label=pgettext("Controller Widgets", "Angle Y Scale"),
            value=1.0,
            min_value=0.5,
            max_value=2.0,
            step=0.01,
            description=pgettext(
                "Controller Widgets",
                "Scale the Y component used for angle calculation.",
            ),
        )
        ...
        self.add_config_item(perspective_angle_y_scale_config)
        ...
        for key in (
            ...
            self.PERSPECTIVE_ANGLE_Y_SCALE_CONFIG_KEY,
    ...
    def create_settings_panel(self) -> Gtk.Widget:
        ...
        perspective_custom_widgets = {
            ...
            self.PERSPECTIVE_ANGLE_Y_SCALE_CONFIG_KEY: self._build_slider_control(
                config_manager, self.PERSPECTIVE_ANGLE_Y_SCALE_CONFIG_KEY
            ),
    ...
    def _get_perspective_model(self) -> PerspectiveEllipseModel:
        ...
        angle_y_scale = self._get_numeric_config(
            self.PERSPECTIVE_ANGLE_Y_SCALE_CONFIG_KEY, 1.0
        )
        ...
        return PerspectiveEllipseModel(
            ...
            angle_y_scale=float(angle_y_scale),
